...
<div class="flex-center position-ref full-height">
    ...
    <div class="content">
        ...
        <div>
            <textarea class="form-control" id="formSwagger" cols="30" rows="10" placeholder="put your swagger doc here"></textarea>
        </div>

        <div>
            <br>
            <a class="btn btn-block btn-light" id="storeBtn">store</a>
        </div>
        <div class="links">
            <br>
